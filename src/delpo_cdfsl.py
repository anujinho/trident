...
from src.zoo.delpo_utils_cdfsl import inner_adapt_delpo, setup
...
taskers = setup(
    args.dataset, args.n_ways, args.k_shots, args.q_shots, args=args)
reconst_loss = nn.MSELoss(reduction='none')
if args.order == False:
    profiler = Profiler('DELPO_cdfsl_{}_{}-way_{}-shot_{}-queries'.format(args.dataset,
...
for model_name in os.listdir(args.model_path):
    ...
    for t in range(args.times):
        for i, tetask in enumerate(taskers):
