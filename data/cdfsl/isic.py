...
class CustomDatasetFromImages(Dataset):
    def __init__(self, args):
        ...
        """
        self.img_path = args.root + "/ISIC2018_Task3_Training_Input/"
        self.csv_path = args.root + "/ISIC2018_Task3_Training_GroundTruth/ISIC2018_Task3_Training_GroundTruth.csv"
...
class SimpleDataset:
    def __init__(self, transform, args, target_transform=identity):
        ...
        d = CustomDatasetFromImages(args)
...
class SetDataset:
    def __init__(self, batch_size, transform, args):
...
class SetDataManager(DataManager):
    ...
    def get_data_loader(self, aug): #parameters that would change on train/val set
        transform = self.trans_loader.get_composed_transform(aug)
        dataset = SetDataset(self.batch_size, transform, self.args)
...
#     base_datamgr            = SetDataManager(84, n_query = 10)
