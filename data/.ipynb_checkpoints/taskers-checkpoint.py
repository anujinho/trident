...
from .loaders import MiniImageNet, Omniglotmix
...
def gen_tasks(dataname, root, image_transforms=None, target_transforms=None, download=False, **task_transforms):
    ...
    Arguments:- 
      ...
      task_transforms: specify n_ways, k_shots, q_queries, num_tasks to create and classes to sample tasks from (if Omniglot) or mode: train/valid/test split to load (if MiniImageNet)"""
